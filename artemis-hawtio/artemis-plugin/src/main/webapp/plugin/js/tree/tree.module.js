...
var Artemis;
(function (Artemis) {
    Artemis.log.info("loading tree");
    Artemis.treeModule = angular
        .module('hawtio-artemis-tree', [])
        .component('artemisTreeHeader', {
            template:
    ...
    Artemis.log.info("loaded tree" + Artemis.treeModule);


    function TreeHeaderController($scope, $element) {
        'ngInject';
        Artemis.log.info("TreeHeaderController ");
        this.$scope = $scope;
        ...
        Artemis.log.info("TreeHeaderController init");
            var _this = this;
        ...
        TreeHeaderController.prototype.search = function (filter) {
                Artemis.log.info("TreeHeaderController search");
            var _this = this;
        ...
        TreeHeaderController.prototype.tree = function () {
                Artemis.log.info("TreeHeaderController tree");
            return $(treeElementId).treeview(true);
        };

        TreeHeaderController.prototype.expandAll = function () {
                Artemis.log.info("TreeHeaderController expand");
            return this.tree()
        ...
        TreeHeaderController.prototype.contractAll = function () {
                Artemis.log.info("TreeHeaderController contract");
            return this.tree()
    ...
    function TreeController($scope, $location, workspace, $element) {
        ...
        Artemis.log.info("TreeController ");
        var artemisJmxDomain = localStorage['artemisJmxDomain'] || "org.apache.activemq.artemis";
        TreeController.prototype.$onInit = function () {
        Artemis.log.info("TreeController onInit");
            var _this = this;
        ...
        TreeController.prototype.populateTree = function () {
            ...
            if (tree) {
                ...
                angular.forEach(children,  function(child) {
                    Artemis.log.info("child=" + child.text + " " + child.id);
                });
